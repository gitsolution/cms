  ...
  <div class="col-md-2">
     <div class="form-group">
      {{Form::label(trans('posadapraiso/labels.hab'),'',array('style' => 'color:white'))  }}
        {{Form::number('habitacion',NULL,['class'=>'form-control','placeholder'=>'','min'=>'1','max'=>'10','step'=>'1','required'] )   }}
    </div>
  </div>
  ...
  <div class="col-md-2">
     <div class="form-group">
      {{Form::label(trans('posadapraiso/labels.adultos'),'',array('style' => 'color:white'))  }}
        {{Form::number('adultos',NULL,['class'=>'form-control','placeholder'=>'','min'=>'0','max'=>'10','step'=>'1','required'])   }}
    </div>
  </div>
   ...
   <div class="col-md-2">
     <div class="form-group">
      {{Form::label(trans('posadapraiso/labels.menores'),'',array('style' => 'color:white'))  }}
        {{Form::number('menores',NULL,['class'=>'form-control','placeholder'=>'','min'=>'0','max'=>'10','step'=>'1','required'])   }}
    </div>
  </div>
