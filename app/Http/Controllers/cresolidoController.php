...
class cresolidoController extends Controller
{
    ...
    public function store(contactoRequest $request)
    {
            ...
            return view('cresolido.contacto');
    }
    ...
    public function Contacto(Request $request)
    {
        ...
        return view('cresolido.contacto',['uris'=>$uris]);
    }

    public function cotizacion(Request $request)
    {
        $uris = $this->getBreadcrumb($request);
        return view('cresolido.frmcotizacion',['uris'=>$uris]);
    }
        ...
        $titulo = 'Historia';
          $Sections =  DB::table('cms_sections')->where('active','=', $flag)->where('publish','=', $publish)->where('id','=', $id_section)->get();             
           ...
           // ->where('cms_categories.id_section','=', $id_section)                        
            ...
            return view('cresolido.home',['Categories'=>$Categories, 'Services'=>$Services,'Sections'=>$Sections,'uris'=>$uris]);
    }
    ...
    public function BlogList(Request $request)
    {
        ...
        $Categories =  DB::table('cms_categories')->where('active','=', $flag)->where('id_section','=', $id_section)->get();             
           ...
           // ->where('cms_categories.id_section','=', $id_section)                        
            ...
            $this->aumentarHits($uri);
            $uris = $this->getBreadcrumb($request);
            return view('cresolido.blog',['Documents'=>$Documents, 'Categories'=>$Categories, 'Sections'=>$Sections, 'uris'=>$uris]);
    }
    ...
    public function Blog($post, Request $request)
    {
        ...
        $Categories =  DB::table('cms_categories')->where('active','=', $flag)->where('id_section','=', $id_section)->get();             
           ...
           $coments= DB::table('cms_comments')
            ...
            return view('cresolido.blog',['Documents'=>$Documents, 'Categories'=>$Categories, 'Sections'=>$Sections,'post'=>$post, 'coments'=>$coments, 'cont'=>$ContComments,'uris'=>$uris]);
}
...
public function section($option, Request $request){
        ...
        return view('cresolido.section',['Sections'=>$Sections, 'uris'=>$uris]);
...
public function category($option, Request $request){
        ...
        $uri=$option;
            ...
            return view('cresolido.category',['Categories'=>$Categories, 'uris'=>$uris]);
}
...
public function document($option, Request $request){
            ...
            return view('cresolido.documents',['Documents'=>$Documents, 'uris'=>$uris]);        
}
